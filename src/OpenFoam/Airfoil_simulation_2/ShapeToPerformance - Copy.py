...
import numpy as np
import Airfoil_simulation_2.utils
...
def calculate_cd_cl(n, num_cores, airfoil_sample_train):
    ...
    for sample_num in range(n * devision_factor, (n + 1) * devision_factor):
        ...
        os.chdir("./Airfoil_simulation_2/OpenFOAM_%d/" % (n))
        ...
        if genMesh(airfoil_sample_train[sample_num, :, :]) != 0:
            ...
            CD = 1000
            os.chdir("../..")
            a_file = open("./Airfoil_simulation_2/results/%d.txt" % (sample_num), "w")
...
def shape_to_performance(airfoil_sample_train):
    ...
    Data_path = "./Airfoil_simulation_2/results/"
