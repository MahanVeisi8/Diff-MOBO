...
if __name__ == "__main__":
    ...
    mat = loadmat('../dataset_openfoam/airfoil_shapes_train.mat')
    X_train = mat['airfoil_shapes']
    mat = loadmat('../dataset_openfoam/GAN1_shapes.mat')
    X_train = np.concatenate((X_train, mat['shapes']), axis=0)
    mat = loadmat('../dataset_openfoam/GAN2_shapes.mat')
    X_train = np.concatenate((X_train, mat['shapes']), axis=0)
    mat = loadmat('../dataset_openfoam/GAN3_shapes.mat')
    X_train = np.concatenate((X_train, mat['shapes']), axis=0)
    mat = loadmat('../dataset_openfoam/GAN4_shapes.mat')
    X_train = np.concatenate((X_train, mat['shapes']), axis=0)


    mat = loadmat('../dataset_openfoam/cl_cd_train.mat')
    Y_train = mat['cl_cd']
    mat = loadmat('../dataset_openfoam/gan1_cl_Cd.mat')
    Y_train = np.concatenate((Y_train, mat['gan1_cl_Cd']), axis=0)
    mat = loadmat('../dataset_openfoam/gan2_cl_Cd.mat')
    Y_train = np.concatenate((Y_train, mat['gan2_cl_Cd']), axis=0)
    mat = loadmat('../dataset_openfoam/gan3_cl_Cd.mat')
    Y_train = np.concatenate((Y_train, mat['gan3_cl_Cd']), axis=0)
    mat = loadmat('../dataset_openfoam/gan4_cl_Cd.mat')
    Y_train = np.concatenate((Y_train, mat['gan4_cl_Cd']), axis=0)
    ...
    #
    mat = loadmat('../dataset_openfoam/airfoil_shapes_test.mat')
    X_test = mat['airfoil_shapes']
    mat = loadmat('../dataset_openfoam/cl_cd_test.mat')
    Y_test = mat['cl_cd']
    ...
    # #in order to maximise with minimization algorithm
    # Y_train = -Y_train
    # Y_test =  -Y_test
