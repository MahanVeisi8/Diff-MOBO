...
# command1 = "ssh nansari@puck docker exec af0194da55a5 ./home/airfoil_UANA/run_rand_dset_1.sh"
# command2 = "ssh nansari@dione docker exec 5f9563809000 ./home/airfoil_UANA/run_rand_dset_2.sh"
# command3 = "ssh nansari@carpo docker exec 48734b2351e7 ./home/airfoil_UANA/run_rand_dset_3.sh"
...
sio.savemat('Dataset/latent_0.mat', {'dset': data})
