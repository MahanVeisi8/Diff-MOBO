...
if __name__== "__main__":
    ...
    # saving the weigths od the UA_model in the updated path
    st = problem_uncertainty.UA_surrogate_model.state_dict()
    torch.save(st , config["UA_surrogate_model"]["saved_update_path"])
